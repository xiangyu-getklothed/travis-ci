...
def fit_single_frame(img,
    ...
    if use_densepose:
        opt_weights_dict['densepose_loss_weight'] = densepose_loss_weights
    ...
    with fitting.FittingMonitor(
        ...
        for or_idx, orient in enumerate(tqdm(orientations, desc='Orientation')):
            ...
            for opt_idx, curr_weights in enumerate(tqdm(opt_weights, desc='Stage')):
                ...
                final_loss_val, final_min_dist = monitor.run_fitting(
                    body_optimizer,
                    closure, final_params,
                    body_model,
                    pose_embedding=pose_embedding, vposer=vposer,
                    use_vposer=use_vposer, camera_fiting=False)
            ...
            if use_densepose:
                print('min_dist in main_function:', final_min_dist)
                result['min_dist'] = final_min_dist.detach().cpu().numpy()
