...
def main(**args):
    ...
    use_densepose = args.get('use_densepose', False)
    ...
    for idx, data in enumerate(dataset_obj):
        ...
        if use_densepose:
            densepose_i = data['densepose_i']
            face_idx_to_atlas_i = data['face_idx_to_atlas_i']
            densepose_loss_weights = args.get('densepose_loss_weight', None)
        else:
            densepose_i = None
